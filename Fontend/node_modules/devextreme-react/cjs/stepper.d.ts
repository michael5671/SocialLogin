...
import dxStepper, { Properties } from "devextreme/ui/stepper";
...
declare const Stepper: <TItem = any, TKey = any>(props: ReplaceFieldTypes<Properties<TItem, TKey>, IStepperOptionsNarrowedEvents<TItem, TKey>> & IHtmlOptions & {
    ...
    defaultItems?: dxStepperItem[] | undefined;
    defaultSelectedIndex?: number | undefined;
    defaultSelectedItem?: any;
    onItemsChange?: ((value: Array<dxStepperItem>) => void) | undefined;
    onSelectedIndexChange?: ((value: number) => void) | undefined;
    onSelectedItemChange?: ((value: any) => void) | undefined;
} & {
    children?: React.ReactNode;
} & {
    ref?: React.Ref<StepperRef<TItem, TKey>> | undefined;
}) => ReactElement | null;
...
export { Stepper, IStepperOptions, StepperRef, Item, IItemProps };
