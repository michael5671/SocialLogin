...
class MessageBox extends DOMComponent {
    ...
    _renderInputContainer() {
        const $messageBox = $("<div>").addClass("dx-chat-messagebox-input-container").appendTo(this.element());
    ...
    _renderTextArea($parent) {
        ...
        const $textArea = $("<div>").addClass("dx-chat-messagebox-textarea");
    ...
    _renderButton($parent) {
        ...
        const $button = $("<div>").addClass("dx-chat-messagebox-button");
