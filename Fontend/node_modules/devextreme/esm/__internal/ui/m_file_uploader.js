...
class FileUploader extends Editor {
    ...
    _updateProgressBar(file, loadedFileData) {
        ...
        null === (_file$progressBar = file.progressBar) || void 0 === _file$progressBar || _file$progressBar.option({
...
class FileUploadStrategyBase {
    ...
    _prepareFileBeforeUpload(file) {
        if (file.$file) {
            ...
            null === (_file$progressBar2 = file.progressBar) || void 0 === _file$progressBar2 || _file$progressBar2.dispose();
