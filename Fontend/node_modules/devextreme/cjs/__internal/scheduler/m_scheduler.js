...
var _index2 = require("./r1/timezone_calculator/index");
var _index3 = require("./r1/utils/index");
...
class Scheduler extends _ui2.default {
    ...
    get currentView() {
        return _index3.viewsUtils.getCurrentView(this.option("currentView"), this.option("views"))
    }
    get currentViewType() {
    ...
    get timeZoneCalculator() {
        if (!this._timeZoneCalculator) {
            this._timeZoneCalculator = (0, _index2.createTimeZoneCalculator)(this.option("timeZone"))
        }
    ...
    _optionChanged(args) {
        var _this$_header2, _this$resourceManager, _this$_header4;
        ...
        switch (args.name) {
            ...
            case "views":
                if (this._getCurrentViewOptions()) {
                    ...
                    var _this$_header;
                    null === (_this$_header = this._header) || void 0 === _this$_header || _this$_header.option(name, value)
                }
                break;
            case "useDropDownViewSwitcher":
                null === (_this$_header2 = this._header) || void 0 === _this$_header2 || _this$_header2.option(name, value);
                break;
            case "currentView":
                ...
                this._postponeResourceLoading().done((groupsResources => {
                    ...
                    null === (_this$_header3 = this._header) || void 0 === _this$_header3 || _this$_header3.option(this._headerConfig());
                    this._filterAppointmentsByDate();
    ...
    _dimensionChanged(value) {
        ...
        if (!this._isAgenda() && this.filteredItems && workspace && !(0, _is_agenda_workpace_component.isAgendaWorkspaceComponent)(workspace)) {
    ...
    _updatePreparedItems(items) {
        this.preparedItems = (0, _index3.getAppointmentDataItems)(items, this._dataAccessors, this._getCurrentViewOption("cellDuration"), this.timeZoneCalculator)
    }
    ...
    _dispose() {
        ...
        this._asyncTemplatesTimers = [];
        _index4.macroTaskArray.dispose();
        super._dispose()
    }
    _initActions() {
        this._actions = {
    ...
    _updateA11yStatus() {
        const dateRange = this._workSpace.getDateRange();
        const indicatorTime = this.option("showCurrentTimeIndicator") ? (0, _index3.getToday)(this.option("indicatorTime"), this.timeZoneCalculator) : void 0;
    ...
    _appointmentsConfig() {
        const config = {
            ...
            isDateAndTimeView: () => (0, _index3.isDateAndTimeView)(this._workSpace.type),
            onContentReady: () => {
    ...
    _getViewCountConfig() {
        ...
        const viewCount = (null === view || void 0 === view ? void 0 : view.intervalCount) || 1;
        const startDate = (null === view || void 0 === view ? void 0 : view.startDate) || null;
        return {
    ...
    _workSpaceConfig(groupsResources, countConfig) {
        ...
        const crossScrollingEnabled = this.option("crossScrollingEnabled") || horizontalVirtualScrollingAllowed || (0, _index3.isTimelineView)(this.currentViewType);
        const result = (0, _extend.extend)({
            resources: this.option("resources"),
            getResourceManager: () => this.resourceManager,
    ...
    _getAppointmentTemplate(optionName) {
        const currentViewOptions = this._getCurrentViewOptions();
        if (null !== currentViewOptions && void 0 !== currentViewOptions && currentViewOptions[optionName]) {
    ...
    _excludeAppointmentFromSeries(rawAppointment, newRawAppointment, exceptionDate, isDeleted, isPopupEditing, dragEvent) {
        const appointment = (0, _index3.excludeFromRecurrence)(rawAppointment, exceptionDate, this._dataAccessors);
    ...
    appointmentTakesAllDay(rawAppointment) {
        const appointment = new _appointment_adapter.AppointmentAdapter(rawAppointment, this._dataAccessors);
        return (0, _index3.isAppointmentTakesAllDay)(appointment, this._getCurrentViewOption("allDayPanelMode"))
    }
    ...
    setTargetedAppointmentResources(rawAppointment, element, appointmentIndex) {
        ...
        if (null !== groups && void 0 !== groups && groups.length) {
            ...
            const appointmentSettings = this._isAgenda() ? this.getLayoutManager()._positionMap[appointmentIndex][0] : _m_utils.utils.dataAccessors.getAppointmentSettings(element) || {};
            const cellGroups = (0, _group_utils.getLeafGroupValues)(groupsLeafs, appointmentSettings.groupIndex);
    ...
    createGetAppointmentColor() {
        return appointmentConfig => (0, _deferred.fromPromise)(this.resourceManager.getAppointmentColor(appointmentConfig))
    }
